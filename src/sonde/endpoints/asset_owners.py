...
from ..endpoint import Endpoint, RequestSpec, PageResult, register
from ..provider import RobloxProvider
...
class AssetOwnersEndpoint(Endpoint):
    ...
    def __init__(self, asset_id, total_copies=None, page_size=100, sort_order="Asc"):
